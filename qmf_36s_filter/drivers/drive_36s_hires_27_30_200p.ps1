# Self-healing driver: high-statistics 36S window scan, 27-30 V, 200 ions/pt.
# Launched as a Scheduled Task so it survives the harness reaping background shells.
...
$Out    = "C:\Users\EMALAB\Documents\Jackson\Beamline Simion\QMF\data\vdc_trapping_36s_hires_27_30_100p.csv"
$PlotDir= "C:\Users\EMALAB\Documents\Jackson\Beamline Simion\QMF\data\plots_36s_hires_27_30_100p"
$DataDir= "C:\Users\EMALAB\Documents\Jackson\Beamline Simion\QMF\data"
$Log    = "C:\Users\EMALAB\Documents\Jackson\Beamline Simion\QMF\data\vdc_trapping_36s_hires_27_30_100p_driver.log"
$Target = 78   # 2 scenarios x 13 vdcs (27.0..30.0 step 0.25) x 3 masses
...
Log "DONE rows=$(Get-Rows)/$Target (raw + abundance + purity + annotated written)"
